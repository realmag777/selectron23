# selectron23
JS drop-down with images and description text. Its can create drop-down in usual div container, and also wrap tag select. Demo on: [codepen.io](https://codepen.io/rostislav-sofronov/pen/NWbeoYy)
